...
namespace XnaDebugPipeLine
{
    ...
    class Program
    {
        ...
        /// </summary>
        private const string ProjectToDebug = @"C:\Users\kalluwa\Documents\visual studio 2010\Projects\PlayMiku\PlayMiku\PlayMikuContent\PlayMikuContent.contentproj";
        ...
        /// 使用注意事项：右击项目设置为启动项目并不会直接按照想要的方式进行，不会在断点下停下来
        /// 这里需要的是右击单个DebugPipeline进行调试，更新这个dll，然后就可以进行调试了
        /// </summary>
        private const string SingleItem = @"Anims\TrueMyHeart.vmd";
        //@"Anims\TrueMyHeart.vmd";
